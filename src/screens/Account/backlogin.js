...
export default function UsuarioLogin({props}) {
  ...
  <View style={styles.view}>
    <Spinner visible={isLoading}/>
     <Image style={styles.logo} source = {require('../../assets/cobbeLogo.jpg')}/>
     <Text style={styles.loginContinueTxt}>{nombre}</Text>
     <Text style={styles.loginContinueTxt}>{Cooperativa}</Text>
     <Text>{test}</Text>
    <TextInput
      style={styles.input}
